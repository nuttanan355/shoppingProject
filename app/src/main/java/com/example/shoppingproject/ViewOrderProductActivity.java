...
public class ViewOrderProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtOrederName = findViewById(R.id.user_view_order_name);
        txtOrederPhone = findViewById(R.id.user_view_order_phone);
        txtOrederAddress = findViewById(R.id.user_view_order_address);
        txtOrederTotal = findViewById(R.id.user_view_order_total);
    ...
    private void showOrderList() {
        FirebaseRecyclerOptions<Cart> options =
                new FirebaseRecyclerOptions.Builder<Cart>()
                        .setQuery(cartListRef.child("orderList"), Cart.class).build();
