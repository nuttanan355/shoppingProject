...
import com.example.shoppingproject.Admin.AdminSendingOrderActivity;
...
public class AdminOrdersTwoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_admin_orders_two, container, false);
    ...
    public void onStart() {
        super.onStart();
            ...
            FirebaseRecyclerOptions<NewOrders>
                    ...
                    .setQuery(ordersRef.orderByChild("OrderStateShipped").equalTo("not shipped"), NewOrders.class).build();
...
//                            String uID = getRef(position).getKey();
                            Intent intent = new Intent(getActivity(), AdminSendingOrderActivity.class);
