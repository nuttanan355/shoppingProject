...
public class AdminSendingOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_sending_order);

        txtOrederName = findViewById(R.id.admin_sending_order_name);
        txtOrederPhone = findViewById(R.id.admin_sending_order_phone);
        txtOrederAddress = findViewById(R.id.admin_sending_order_address);
        txtOrederTotal = findViewById(R.id.admin_sending_order_total);
        txtOrederPackage = findViewById(R.id.admin_sending_order_package);
