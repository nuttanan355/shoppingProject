...
public class AdminOrdersHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtOrederName = findViewById(R.id.admin_history_order_name);
        txtOrederPhone = findViewById(R.id.admin_history_order_phone);
        txtOrederAddress = findViewById(R.id.admin_history_order_address);
        txtOrederTotal = findViewById(R.id.admin_history_order_total);
        txtOrederPackage = findViewById(R.id.admin_history_order_package);
